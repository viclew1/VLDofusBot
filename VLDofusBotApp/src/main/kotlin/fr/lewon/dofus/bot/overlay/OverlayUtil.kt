...
object OverlayUtil {
    ...
    fun buildInfoWindow(g: Graphics, toDrawLines: List<OverlayInfoLine>): BufferedImage {
        val width = toDrawLines.maxOfOrNull { it.getWidth(g) }
            ?: error("You need at least one line to draw")
