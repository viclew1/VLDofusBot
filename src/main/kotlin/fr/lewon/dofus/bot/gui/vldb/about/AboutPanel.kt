package fr.lewon.dofus.bot.gui.vldb.about
...
object AboutPanel : JPanel(MigLayout()) {

    private const val githubLink = "https://github.com/viclew1/VLDofusBot"
    private const val message =
        "<html>Thank you for using VL Dofus Bot, feel free to visit the project github page for issues, suggestions or just to give it a star ! <br><br>" +
                "Link to the project :"
