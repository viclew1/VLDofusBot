...
class CharacterCardList : JPanel(MigLayout("insets 0")) {
    ...
    private var selectedCharacter: DofusCharacter? = DTBCharacterManager.getCurrentCharacter()
    ...
    init {
        ...
        SwingUtilities.invokeLater {
            ...
            for (character in DTBCharacterManager.getCharacters()) {
    ...
    fun selectCharacter(characterCard: CharacterCard) {
        DTBCharacterManager.setCurrentCharacter(characterCard.character)
    ...
    fun removeCharacter(characterCard: CharacterCard) {
        DTBCharacterManager.removeCharacter(characterCard.character)
