...
import fr.lewon.dofus.bot.sniffer.model.messages.stats.KamasUpdateMessage
...
object KamasUpdateEventHandler : IEventHandler<KamasUpdateMessage> {
    override fun onEventReceived(socketResult: KamasUpdateMessage, connection: DofusConnection) {
        ...
        CharacterGlobalInformationUIUtil.updateCharacterKamas(gameInfo.character.name, socketResult.kamasTotal)
    }
}